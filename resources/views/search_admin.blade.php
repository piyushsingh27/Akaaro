        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                        ...
                        <form action="{{route('admin.search_location')}}" method="GET" class="search-form">
                                <span class="glyphicon glyphicon-search"></span>
                        ...
                        <form action="{{route('admin.search_current_location')}}" method="GET" class="search-form">
                                <span class="glyphicon glyphicon-search"></span>
                        ...
                        <div class="col-md-10 offset-md-1">
                            <form action="{{route('admin.search_skills')}}" method="GET">
                                @csrf
                                    <span class="glyphicon glyphicon-search"></span>
                                ...
                                <div class="form-group row mb-0">
                                    <div class="col-md-10">
                                        <button type="submit" class="btn btn-primary">
                                            {{ __('Search Candidates with any key skills') }}
                                        </button>
                                    </div>
                                </div>
                            </form>
                        ...
                        <div class="col-md-10 offset-md-1">
                            <form action="{{route('admin.search_skills&')}}" method="GET">
                                ...
                                <div class="form-group row mb-0">
                                    <div class="col-md-10">
                                        <button type="submit" class="btn btn-primary">
                                            {{ __('Search Candidates with all key skills') }}
                                        </button>
                                    </div>
                                </div>
                            </form>
                        ...
                        <div class="col-md-10 offset-md-1">
                            <form action="{{route('admin.search_resume')}}" method="GET">
                                ...
                                <div class="form-group row mb-0">
                                    <div class="col-md-6">
                                        <button type="submit" class="btn btn-primary">
                                            {{ __('Search Candidates with any skills') }}
                                        </button>
                                    </div>
                                </div>
                            </form>
                        ...
                        <div class="col-md-10 offset-md-1">
                            <form action="{{route('admin.search_resume&')}}" method="GET">
                                ...
                                <div class="form-group row mb-0">
                                    <div class="col-md-6">
                                        <button type="submit" class="btn btn-primary">
                                            {{ __('Search Candidates with all skills') }}
                                        </button>
                                    </div>
                                </div>
                            </form>
