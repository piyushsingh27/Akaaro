    ...
    <div class="row justify-content-center">
        <div class="col-md-7">
            <div class="card">
                ...
                {{-- <h1>Edit Details</h1> --}}
                <div class = "card-body">
                {!! Form::model($candidate, array('route' => array('candidatesad.update', $candidate->id), 'method' => 'PUT', 'enctype' => 'multipart/form-data')) !!}
