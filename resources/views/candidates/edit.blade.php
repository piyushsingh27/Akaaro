...
@section('content')
    ...
    {!! Form::model($candidate, array('route' => array('candidates.update', $candidate->id), 'method' => 'PUT', 'enctype' => 'multipart/form-data')) !!}
        ...
        <div class = "form-group">
            ...
            {{Form::text('email',$candidate->email, ['class' => 'form-control', 'placeholder' => 'email'])}}
        </div>
        ...
        <div class = "form-group">
            {{Form::label('DOB','DOB')}}
            {{Form::text('DOB',$candidate->DOB, ['class' => 'form-control', 'placeholder' => 'DOB'])}}
        </div>
        ...
        <div class = "form-group">
            ...
            {{Form::text('experience',$candidate->experience, ['class' => 'form-control', 'placeholder' => 'experience'])}}
        </div>

        <div class = "form-group">
            {{Form::label('salary','Salary')}}
            {{Form::text('salary',$candidate->salary, ['class' => 'form-control', 'placeholder' => 'salary'])}}
        </div>

        <div class = "form-group">
            {{Form::label('cv_last_modified','CV_last_modified')}}
            {{Form::text('cv_last_modified',$candidate->cv_last_modified, ['class' => 'form-control', 'placeholder' => 'cv_last_modified'])}}
        </div>
